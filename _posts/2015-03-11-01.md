...
从矢量分析可以得到天线阵归一化方向性函数为

>\\(F (\theta ) = \frac{|E(\theta )|}{|E(\theta )| _{max} } = \left| \frac{1}{N} \frac{sin[\frac{N}{2}(\psi - \varphi _1)]}{sin[\frac{1}{2}(\psi - \varphi _1)]}\right|\\)

>\\(= \left| \frac{1}{N} \frac{sin[\frac{N}{2}(\frac{2 \pi}{\lambda }d \sin \theta - \varphi _1)]}{sin[\frac{1}{2}(\frac{2 \pi}{\lambda }d \sin \theta - \varphi _1)]}\right|\\)

而\\(\varphi _1 = \frac{2 \pi}{\lambda} d \sin \theta _1\\)，因此
