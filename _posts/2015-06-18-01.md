...
>\\(\frac{ {\cal{E} } }{N} = \int _0 ^{\varepsilon _{\sc F} } \varepsilon g (\varepsilon) {\rm d} \varepsilon / \int _0 ^{\varepsilon _{\sc F} } g (\varepsilon) {\rm d} \varepsilon \\)
>\\(= \int _0 ^{\varepsilon _{\sc F} } \varepsilon ^{\frac{3}{2} } {\rm d} \varepsilon / \int _0 ^{\varepsilon _{\sc F} } \varepsilon ^{\frac{1}{2} } {\rm d} \varepsilon \\)
>\\(= \frac{3}{5} \varepsilon _{\sc F} \\)
